...
TELEGRAM_BOT_TOKEN = '7756897227:AAFUAiMsr5o6lsUpGXKpQqRMR2azV0elpok'
ADMIN_USER_ID = 1512502510
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to the rjravisinghania 🔥*\n\n"
        "*Use /attack <ip> <port> <duration>*\n"
        "*Buy Private File @rjravisinghania ⚔️💥*"
    )
